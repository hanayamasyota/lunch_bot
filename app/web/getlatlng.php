...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC2tnzNvq7H-AGrGdPrUdSpRTIASeim0nk"></script>
    ...
    <body onload="javascript:init();" class="bg-lightnavy py-2">
        ...
        <center>
            <input type="text" value="" id="place" placeholder="住所や地名を入力" class="input-lg w-50 h-4rem">
        ...
        <form method="post" action="<?php echo $url; ?>">
            <div class="input">
                緯度：<input type="text" id="lat" name="lat" value="" class="input-group-lg w-25 h-2rem">
                経度：<input type="text" id="lng" name="lng" value="" class="input-group-lg w-25 h-2rem"><br><br>
            </div>
